...
<img style="margin-left: 7%; width: 80%; border-radius: 11px;" src="img/Select-Orig.png">
...
<img style="margin-left: 1%; width: 60%;" src="img/ID.png">

**5.** Enter the number of terms in the set
<img style="margin-left: 1%; width: 60%;" src="img/Num-Terms.png">
...
<img style="margin-left: 7%; width: 80%; border-radius: 11px;" src="img/Options.png">

**7.** Start the game! Your computer will automatically enter and submit the definitions while the Gravity tab is frontmost.
<img style="margin-left: 7%; width: 80%; border-radius: 11px;" src="img/Start-Game.png">